...
@router.get("", response_model=list[UsuarioOut], summary="Lista todos os usuários")
async def listar(service: UsuarioService = Depends(get_usuario_service)):
    return await service.listar()


@router.get("/{usuario_id}", response_model=UsuarioOut, summary="Busca um usuário por ID")
...
@router.put("/{usuario_id}", response_model=UsuarioOut, summary="Atualiza um usuário")
async def atualizar(
    usuario_id: str,
